      ...
      {isAuthenticated && (
        <div className='flex flex-wrap gap-3'>
          {editHref && (
            <Link
              href={editHref}
              className='flex items-center px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors text-sm md:text-base'
            >
          ...
          {onDelete && (
            <button
              onClick={onDelete}
              className='flex items-center px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 transition-colors text-sm md:text-base cursor-pointer'
            >
